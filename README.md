...
## إضافات النذرايت
(لاعطاء النذرايت قيمة اكبر في نهاية اللعبه)

### godpickaxe

<p align="center">
  <img src="pics/gb.png" width="600">
</p>

- ⛏️ تكسير 3x3 — إذا كسرت بلوكة وحده، راح يكسر مساحة 3x3 مباشرة حسب الجهة اللي كسرتها
- 🚫 ماتقدر تحطه في الـ Ender Chest عشان يكون اللعب متوازن
- 🕒 البيكاكس راح يتحول إلى غبار كل يوم خميس
- ⚒️ فقط 7 بيكاكسات ينصنعون في كل فترة من الخميس إلى الخميس، فالحق ما تلحق
- 📅 تقدر تشوف رقم الفتره وعدد البيكاكسات المصنوعه بالأمر `/godpick`

### Netherite Anvils

<p align="center">
  <img src="pics/na.png" width="600">
</p>

- 💸 تكلفة التصليح مفتوحة — يشيل حد الأنفل العادي (39 لفل)، ويتجاوز رسالة "Too Expensive" للأغراض اللي تتصلح أو تنصنع باستخدام Netherite Anvils
- 🛡️ الأنفل ما ينكسر أبدًا — Netherite Anvils ما تتشقق ولا تتكسر لا مع الاستخدام، ولا مع الطيحة، ولا حتى مع الانفجارات
